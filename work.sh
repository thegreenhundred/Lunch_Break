...
colors=($blue $cyan $red $green $darkgrey $black $brightcyan)
### End customization

### Do not edit below this line
spacing=${9:-160} # the likelihood of a character being left in place
scroll=${1:-0} # 0 for static, positive integer determines scroll speed
screenlines=$(expr `tput lines` - 3 + $scroll)
screencols=$(expr `tput cols` / 1 - 1)

chars=(WORK HARD GRINDING LABOR CALL ANSWER EMAIL FIX BROKEN COMPUTER CUSTOMER)
# charset via Carl:
